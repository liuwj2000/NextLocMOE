...
def load_history_data(name,type):
    file_dir='./data/llmmob/Shanghai/llmmob/Shanghai/history_'+name+'_'+type+'.pkl'
    #print(file_dir)
    f=open(file_dir,'rb')
    data=pickle.load(f)
...
def load_content_data(name,type):
    file_dir='./data/llmmob/Shanghai/llmmob/Shanghai/context_'+name+'_'+type+'.pkl'
    #print(file_dir)
    f=open(file_dir,'rb')
    data=pickle.load(f)
    #print('load file: ',f,' finished')
...
def load_content_data_true(name,type):
    file_dir='./data/llmmob/Shanghai/llmmob/Shanghai/context_true_'+name+'_'+type+'.pkl'
    #print(file_dir)
    f=open(file_dir,'rb')
    data=pickle.load(f)
    #print('load file: ',f,' finished')
...
class ShanghaiDataset(AbstractDataset):
    ...
    def get_data(self):
        ...
        self.loc_x_mean=13521366.994944716
        self.loc_y_mean=3663228.867087356

        self.loc_x_std=5871.087266118369
        self.loc_y_std=5945.086297594644
        self.duration_max=130
